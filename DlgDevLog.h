...
class CDlgDevLog : public CDialog
{
	DECLARE_DYNAMIC(CDlgDevLog)

public:
	CDlgDevLog(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgDevLog();

// 对话框数据
    enum { IDD = IDD_DLG_DEV_LOG };
...
public:
    ...
    NET_EHOME_DEV_LOG_COND m_DevLogCond;
    NET_EHOME_DEV_LOG m_DevLog;
